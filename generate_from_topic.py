...
prompt_template = PromptTemplate(
    ...
    - **Medium (5-8):** Requires moderate analysis, problem-solving, and conceptual application.
    - **Hard (9-10):** Complex decision-making, real-world application, or critical thinking.
...
def generate_mcqs_from_topic(topic, difficulty):
    ...
    try:
        ...
        if result:
            print("\n\n\nGenerated MCQs Response:", result)  # Debugging output
        return result
